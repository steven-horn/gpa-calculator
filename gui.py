...
class Gui:
    def __init__(self, window):
        ...
        self.grade_one_label = Label(self.frame_one_class, width=8, text='Grade: ')
        ...
        self.one_label = Label(self.one_labelframe, width=33, wraplength=300, text='')
        ...
        self.grade_two_label = Label(self.frame_two_class, width=8, text='Temp')
        ...
        self.two_label = Label(self.two_labelframe, width=33, wraplength=300, text='')
        ...
        self.grade_three_label = Label(self.frame_three_class, width=8, text='Temp')
        ...
        self.three_label = Label(self.three_labelframe, width=33, wraplength=300, text='')
        ...
        self.grade_four_label = Label(self.frame_four_class, width=8, text='Temp')
        ...
        self.four_label = Label(self.four_labelframe, width=33, wraplength=300, text='')
        ...
        self.grade_five_label = Label(self.frame_five_class, width=8, text='Temp')
        ...
        self.five_label = Label(self.five_labelframe, width=33, wraplength=300, text='')
    ...
    def class_one_grades(self):
        ...
        self.class_one_average()
        self.add_one_entry.delete(0, END)

    def class_one_average(self):
        numbers = list(map(int, self.grades_list_one))
        x = average(numbers)
        letter = letter_grade(x)
        self.grade_one_label.config(text=f'Grade: {letter}')
